  ...
  const cardsData = [
    {
      ...
      handle: "@Rajesh",
      content:
        "We started with the ₹7,999 plan – ended up upgrading to the full 365 plan! They’re fast, creative, and supportive.",
      place: "Tiruppur",
    },
    {
      name: "Shanthi",
      handle: "@Shanthi",
      content:
        "BMTechX gave me a professional site in 3 days. Now I’m getting more WhatsApp leads than ever!",
      place: "Salem",
    },
    {
      name: "Megha",
      handle: "@Megha",
      content:
        "They don’t just make websites. They understand your business goals.",
      place: "Chennai",
    },
    {
      name: "Suresh",
      handle: "@Suresh",
      content:
        "Thanks to the 365 Posts Plan, my brand shows up every day without fail. Our Instagram now looks consistent, professional, and it’s converting followers into real customers!",
      place: "Erode",
    },
  ];
      ...
      <div className="p-6 bg-white rounded-lg mx-4 shadow-lg hover:shadow-xl transition-all duration-200 w-80 shrink-0 border border-gray-100">
        <div className="flex gap-3 items-center">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-gray-500">{card.place}</span>
          </div>
        </div>
...
>
  <h1 className="text-3xl md:text-5xl font-extrabold text-white leading-tight">
    What Our
    <span className="text-[#facc15] not-italic"> Clients Say</span>
  </h1>
</motion.div>
